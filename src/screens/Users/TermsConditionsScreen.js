  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <TermsHeaderComponent
        onPress={null} //() => setModalVisible(true)}
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.paragraph}>
          These Terms and Conditions (“Terms”) govern your use of the Bite food
          delivery mobile application and website (the “Platform”) operated by
          [Your Company Name] (“Company”, “we”, “us”, or “our”). By accessing or
